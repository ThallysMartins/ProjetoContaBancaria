...
namespace ProjetoFinança
{
    public class Executar()
    {
        ...
        {
            ContaBancaria contaComum = new ContaCorrente("Thallys Comum", 1000);
            ...
            while (true)
            {
                ...
                {
                    Console.WriteLine("4 - Alicar Desconto");
                }
                ...
                {
                    poupança.CalcularRendimentos();
                }

                else if (escolha == "4" && contaAtiva is ContaCorrente corrente)
                {
                    corrente.CalcularRendimentos();
                }
